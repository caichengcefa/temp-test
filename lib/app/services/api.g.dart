...
class _ApiService implements ApiService {
  ...
  @override
  Future<User> postLogin(dynamic params) async {
  ...
  Future<Test> getTest() async {
    ...
    final _options = _setStreamType<Test>(
    ...
    late Test _value;
    try {
      _value = Test.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<String> getSecret(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
